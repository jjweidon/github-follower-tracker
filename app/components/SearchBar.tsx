      ...
      <form onSubmit={handleSubmit} className="flex justify-center items-center gap-4 max-w-3xl mx-auto">
        <div className="relative flex-1 group">
          ...
          <input
            ...
            className="w-full px-6 py-4 rounded-xl bg-white/95 backdrop-blur-sm border border-accent-cyan/30 text-gray-900 text-lg placeholder-gray-500 focus:border-accent-purple/50 focus:ring-2 focus:ring-accent-purple/20 transition-all font-mono relative z-10"
            disabled={loading}
          />
        </div>
        <button
          type="submit"
          disabled={loading}
          className="relative px-8 py-4 rounded-xl bg-black text-white font-bold text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-accent-purple/50 group overflow-hidden"
        >
